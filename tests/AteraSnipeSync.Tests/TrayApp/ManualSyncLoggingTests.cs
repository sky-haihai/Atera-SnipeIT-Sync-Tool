...
/// <summary>
/// Verifies lossless detailed file logging and the intentionally minimal manual-sync UI milestone policy.
/// </summary>
public sealed class ManualSyncLoggingTests
{
    [Fact]
    ...
    {
        var tracker = new ManualSyncUiStageTracker();
