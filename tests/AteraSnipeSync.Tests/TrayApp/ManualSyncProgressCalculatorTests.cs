...
/// </summary>
public sealed class ManualSyncProgressCalculatorTests
{
    [Fact]
    public void Calculate_RealSync_ReservesMostProgressForAssetExecution()
    {
        var calculator = new ManualSyncProgressCalculator(previewOnly: false);
    ...
    {
        var calculator = new ManualSyncProgressCalculator(previewOnly: true);
    ...
    private static int Calculate(
        ManualSyncProgressCalculator calculator,
        string stage,
        string message,
        int? current = null,
        int? total = null,
