...
/// <summary>
/// Converts detailed manual-sync progress into five stable Dashboard status milestones while leaving per-record details for file logging.
/// </summary>
internal sealed class SyncUiStageTracker
{
    private Stage _stage;

    /// <summary>
    /// Starts a new manual run and returns its initial Dashboard status.
    /// </summary>
    public string Start()
    {
    ...
    /// <summary>
    /// Observes one detailed progress callback and returns only a newly reached ordered Dashboard milestone.
    /// </summary>
